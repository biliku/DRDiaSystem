...
urlpatterns = [
    ...
    path('users/patients/', views.patient_list, name='patient_list'),
    ...
    # 医生端获取患者医疗信息API - 使用不同的前缀避免冲突
    path('patient/<int:patient_id>/medical-info/', views.patient_medical_info, name='patient_medical_info'),
]
